<cfcomponent output="false" hint="I am the CfMinify api component. Instantiate me with configuration options and use my include(), includeData() and renderIncludes() methods to awesomely manage your static includes" extends="org.cfstatic.util.Base">
	...
	<!--- constructor --->
		<cffunction name="init" access="public" returntype="any" output="false" hint="I am the constructor for CfStatic. Pass in your CfStatic configuration options to me.">
			...
			<cfargument name="useGoogleClosure" 	 type="boolean" required="false" default="false"     hint="Whether or not to to use the Google Closure Compiler rather than YUI for JavaScript" />
	...
	<!--- plain old instance property accessors (private) --->
		...
		<cffunction name="_getUseGoogleClosure" access="private" returntype="boolean" output="false">
			<cfreturn _useGoogleClosure>
		</cffunction>
		<cffunction name="_setUseGoogleClosure" access="private" returntype="void" output="false">
			<cfargument name="useGoogleClosure" type="boolean" required="true" />
			<cfset _useGoogleClosure = arguments.useGoogleClosure />
		</cffunction>
		...
		<cffunction name="_setClosureCompiler" access="private" returntype="void" output="false">
			<cfargument name="closureCompiler" required="true" type="any" />
			<cfset _closureCompiler = closureCompiler />
		</cffunction>
		<cffunction name="_getClosureCompiler" access="private" returntype="any" output="false">
			<cfreturn _closureCompiler />
		</cffunction>
